...
## Open-space mouse aiming: inertial turn-to-cursor with a control-scheme setting  [DRAFT - preparation in progress]  (`open-space-mouse-aiming-inertial-turn-to-cursor-with-a-contr`, 3 open)

**Preparation**

- [ ] **Research: Open-space mouse aiming: inertial turn-to-cursor with a control-scheme setting** _(todo - research)_
...
- [ ] **Plan review: Open-space mouse aiming: inertial turn-to-cursor with a control-scheme setting** _(todo - plan-review)_
...
- Add Boost/Burst Movement to Open Space  _(submitted 2026-09-13T13:14:11.413Z)_
