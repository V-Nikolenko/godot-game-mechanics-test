...
const _ICON_ASSAULT      := preload("res://open_space/assets/sprites/mission_select_ui/menu/menu_mission_select_list_item_icon_assault.png")
const _ICON_INFILTRATION := preload("res://open_space/assets/sprites/mission_select_ui/menu//menu_mission_select_list_item_icon_land.png")
const _ICON_UNKNOWN      := preload("res://open_space/assets/sprites/mission_select_ui/menu//menu_mission_select_list_item_icon_unknown.png")
